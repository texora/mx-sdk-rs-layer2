...
impl DebugApi {
    ...
    fn prepare_execute_on_dest_context_input(
        ...
        let async_call_data = self.create_async_call_data(to, moa_value, func_name, args);
    ...
    fn perform_execute_on_dest_context(
        ...
        let tx_input = self.prepare_execute_on_dest_context_input(to, moa_value, func_name, args);
...
impl SendApiImpl for DebugApi {
    ...
    fn deploy_contract<M: ManagedTypeApi>(
        ...
        let (new_address, result) =
            self.perform_deploy(contract_code, moa_value, arg_buffer.to_raw_args_vec());
