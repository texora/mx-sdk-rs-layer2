...
impl BlockchainStateWrapper {
        ...
        ContractObjBuilder: 'static + Copy + Fn() -> CB,
    {
        ...
        if moa_payment > &rust_zero {
            tx_cache.subtract_moa_balance(caller, moa_payment);
            tx_cache.increase_moa_balance(sc_address, moa_payment);
        }
        ...
        let tx_input = build_tx_input(caller, sc_address, moa_payment, dct_payments);
