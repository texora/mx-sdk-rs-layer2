...
FORWARDER_ADDRESS_HEX="0x$(moapy wallet bech32 --decode ${FORWARDER_ADDRESS_BECH32})"

VAULT_ADDRESS_BECH32=
VAULT_ADDRESS_HEX="0x$(moapy wallet bech32 --decode ${VAULT_ADDRESS_BECH32})"
...
echoNoArgs() {
    moapy --verbose contract call ${FORWARDER_ADDRESS_BECH32} \
