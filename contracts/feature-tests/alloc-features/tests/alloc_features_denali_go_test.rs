...
fn crypto_elliptic_curves_legacy_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_elliptic_curves_legacy.scen.json");
}

#[test]
fn crypto_keccak256_legacy_alloc_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_keccak256_legacy_alloc.scen.json");
}

#[test]
fn crypto_ripemd160_legacy_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_ripemd160_legacy.scen.json");
}

#[test]
fn crypto_sha256_legacy_alloc_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_sha256_legacy_alloc.scen.json");
}

#[test]
fn crypto_verify_bls_legacy_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_verify_bls_legacy.scen.json");
}

#[test]
fn crypto_verify_ed25519_legacy_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_verify_ed25519_legacy.scen.json");
}

#[test]
fn crypto_verify_secp256k1_legacy_go() {
    dharitri_wasm_debug::denali_go("denali/crypto_verify_secp256k1_legacy.scen.json");
}
...
fn echo_big_int_nested_alloc_go() {
    dharitri_wasm_debug::denali_go("denali/echo_big_int_nested_alloc.scen.json");
}
...
fn echo_multi_value_tuples_alloc_go() {
    dharitri_wasm_debug::denali_go("denali/echo_multi_value_tuples_alloc.scen.json");
}
...
fn echo_varargs_u32_alloc_go() {
    dharitri_wasm_debug::denali_go("denali/echo_varargs_u32_alloc.scen.json");
}
...
fn managed_buffer_load_slice_go() {
    dharitri_wasm_debug::denali_go("denali/managed_buffer_load_slice.scen.json");
}
...
fn managed_buffer_set_slice_go() {
    dharitri_wasm_debug::denali_go("denali/managed_buffer_set_slice.scen.json");
}

#[test]
fn only_owner_legacy_go() {
    dharitri_wasm_debug::denali_go("denali/only_owner_legacy.scen.json");
}
...
fn storage_address_go() {
    dharitri_wasm_debug::denali_go("denali/storage_address.scen.json");
}

#[test]
fn storage_opt_address_go() {
    dharitri_wasm_debug::denali_go("denali/storage_opt_address.scen.json");
}
