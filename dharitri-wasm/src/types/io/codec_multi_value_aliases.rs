use dharitri_codec::multi_types::{IgnoreValue, OptionalValue};
...
#[cfg(feature = "alloc")]
pub type MultiArgVec<T> = dharitri_codec::multi_types::MultiValueVec<T>;
...
#[cfg(feature = "alloc")]
pub type VarArgs<T> = dharitri_codec::multi_types::MultiValueVec<T>;
...
#[cfg(feature = "alloc")]
pub type MultiResultVec<T> = dharitri_codec::multi_types::MultiValueVec<T>;
